        ...
        if self.n_calls % self.check_freq == 0:
          ...
          for _ in range(1):
            ...
            while not Done:
              ...
              action,state = self.model.predict(observation,state,deterministic=True)
              rewardSum += reward
...
if __name__ == "__main__":
    ...
    model =DQN("CnnPolicy",env,verbose=1,batch_size=256)
    model.learn(total_timesteps=2048*100,progress_bar=True,log_interval=4,callback=callback)
